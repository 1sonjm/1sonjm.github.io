...
4. Add `remote_theme: "mmistakes/minimal-mistakes@4.15.21"` to your `_config.yml` file. Remove any other `theme:` or `remote_theme:` entry.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTI0NDY5NTRdfQ==
-->