...
## CA
CA(**C**ertificate **A**uthority)는 X.509 표준을 준수하는 디지털 인증서를 발급하는 곳 입니다. 디지털 인증서는 인증서 소유자 (주체)의 공개 키를 인증하고 소유자는 인증서로 보호되는 도메인을 제어합니다. 따라서 신뢰할 수있는 제 3 자로서의 역할을 수행하여 클라이언트가 검증 된 엔터티가 운영하는 서버에 연결한다는 보증을 제공합니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODI0NTMzNDAsLTIwODk4NzI1NTksMTQ1NT
MxMDgxOSwtNzUwMzM2Njg1LC0xNDcwNzMyODgyLC03NTM3MzM4
NywtMjMxNTQ3MTc2XX0=
-->