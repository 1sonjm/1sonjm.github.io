...
<!-- Meramid API include -->
<script src="/assets/js/mermaid-8.0.0.min.js"></script>
# TLS
...
```
1.  통신상태 확인을 위한 hello 메시지로 정보 교환 (TLS 버전, 암호 모음 목록, 난수 및 압축 방법 목록)
2.  통신상태 확인을 위한 hello 메시지로 정보 교환 (TLS 버전, 암호 모음 목록, 난수 및 압축 방법 목록)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDU2MzUxMzMsLTUxODMxNzg3NSwyNjk1MT
k4ODAsLTQxNzEwMjUyMSwxODQyNzM3MzkzLC00NjYwNTI0LC03
NDE3NjUwNjcsLTE4NzE2OTQ1NTNdfQ==
-->